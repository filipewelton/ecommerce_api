defmodule EcommerceApiWeb.ManagersController.SignInTest do
  ...
  @url "/api/stores/managers/sign-in"
  @password Faker.String.base64(12)

  setup do
    data =
      build(:store_manager, password: @password)
      |> JSONParse.call()
  ...
  describe "sign-in" do
    test "should return manager data", %{conn: conn, email: email} do
      payload = %{
        "email" => email,
        "password" => @password
      }
