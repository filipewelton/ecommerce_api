defmodule EcommerceApiWeb.EmployeesController.DeleteTest do
  ...
  describe "delete" do
    test "should delete employee", %{conn: conn, id: id, token: token} do
      params = %{"session_token" => token}

      conn
      |> delete("/api/stores/employees/#{id}", params)
      |> response(204)
    end
